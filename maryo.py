...
class dragon:
    ...
    def __init__(self):
        self.image = load_image('Assets/dragon.png')
...
class flames:
    ...
    def __init__(self):
        self.image = load_image('Assets/fireball.png')
        self.imagerect = self.image.get_rect()
...
class maryo:
    ...
    def __init__(self):
        self.image = load_image('Assets/maryo.png')
        self.imagerect = self.image.get_rect()
